...
const Navbar = () => {
  ...
  return (
    <nav className="navbar">
      ...
      <div className={`absolute bg-white w-full left-0 top-full mt-0 border-b border-grey py-4 px-[5vw] md:border-0 md:block md:relative md:inset-0 md:p-0 md:w-auto ${searchBoxVisibility ? "show" : "hide"}`}>
        <input 
          type="text"
          placeholder="Search"
      ...
      <div className='flex items-center gap-3 md:gap-6 ml-auto'>
        ...
        >
          <i className='fi fi-rr-search text-2xl mt-[6px]'/>
        </button>
        <Link
          to="/editor"
